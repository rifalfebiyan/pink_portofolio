...
import { Home,User, Code, Mail, Briefcase, Star, Award, Github, Linkedin, Twitter } from 'lucide-react';
...
const HomePage = () => {
  ...
  const skillsData = [
    { name: 'React', value: 90, color: '#F472B6' }, // Rose 400
    { name: 'JavaScript', value: 85, color: '#EC4899' }, // Pink 500
    { name: 'Tailwind CSS', value: 80, color: '#DB2777' }, // Pink 600
    { name: 'Node.js', value: 70, color: '#BE185D' }, // Rose 700
    { name: 'HTML/CSS', value: 95, color: '#A21CAF' }, // Fuchsia 700
  ];
  ...
  const projects = [
    {
      ...
      image: 'https://placehold.co/400x250/FBCFE8/881337?text=Proyek+1' // Light pink background, dark pink text
    },
    {
      id: 2,
    ...
    <div className="min-h-screen bg-pink-50 font-sans text-gray-800">
      ...
      <nav className="fixed top-0 w-full bg-white shadow-lg z-50 p-4">
        <div className="container mx-auto flex justify-between items-center">
          <div className="text-2xl font-bold text-rose-600">Portofolio Saya</div>
      ...
      <section id="home" className="relative pt-24 pb-16 bg-gradient-to-r from-pink-400 to-rose-600 text-white flex items-center justify-center min-h-screen-75 rounded-b-3xl shadow-lg">
        <div className="container mx-auto text-center p-6">
          <img
            src="https://placehold.co/150x150/FCE7F3/BE185D?text=Foto+Profil" // Pink background, rose text
            alt="Foto Profil"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center md:space-x-12">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <img
                src="https://placehold.co/500x350/FCE7F3/BE185D?text=Tentang+Saya" // Pink background, rose text
                alt="Tentang Saya"
